...
export function ChannelSettings() {
  ...
  // New: Manual/API connection button handler
              ...
              <div className="space-y-3 mt-2">
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        <h3 className="font-semibold text-gray-900">Manual/API Connection</h3>
                        <Badge className="text-[10px] bg-purple-100 text-purple-700 border-purple-200">Manual</Badge>
                      </div>
                      <p className="text-sm text-gray-600 mb-2">
                        Enter WhatsApp API, Business ID, Phone ID, App ID, and App Secret manually for advanced setup.
                      </p>
                      <div className="flex flex-wrap gap-x-4 gap-y-1 text-xs text-gray-500">
                        <span className="flex items-center gap-1"><Check className="w-3 h-3 text-green-500" /> Full manual control</span>
                        <span className="flex items-center gap-1"><Check className="w-3 h-3 text-green-500" /> Use your own credentials</span>
                        <span className="flex items-center gap-1"><Check className="w-3 h-3 text-green-500" /> No Facebook login required</span>
                      </div>
                    </div>
